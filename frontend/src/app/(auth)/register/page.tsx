...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast.success("Account created! Welcome to BhashaSetu ≡ƒÄë");
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Start your journey with BhashaSetu AI ΓÇö free forever</p>
      </div>
